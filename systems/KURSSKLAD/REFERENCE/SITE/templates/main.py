...
__CHEETAH_genTime__ = 1482336171.9360001
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:51 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REFERENCE\\SITE\\templates\\main.tmpl'
...
class main(engine_main):
    ...
    def adminData(self, **KWS):
        ...
        ## CHEETAH: generated from #block adminData at line 44, col 5.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write('''        <script>
            var useviewunit = ''')
        _v = VFFSL(SL,"viewunit",True) # '$viewunit' on line 46, col 31
        if _v is not None: write(_filter(_v, rawExpr='$viewunit')) # from line 46, col 31.
        write(''';
        </script>
...
''')
        ...
        write('''/k.site.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="''')
