...
__CHEETAH_genTime__ = 1482336171.7920001
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:51 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REFERENCE\\AUTO\\templates\\main.tmpl'
...
class main(engine_main):
    ...
    def adminData(self, **KWS):
        ...
        ## CHEETAH: generated from #block adminData at line 37, col 2.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
...
\t<script type="text/javascript" src="''')
    ...
    <script type="text/javascript" src="''')
        _v = VFFSL(SL,"sp_js",True) # '$sp_js' on line 35, col 41
        if _v is not None: write(_filter(_v, rawExpr='$sp_js')) # from line 35, col 41.
        write('''/auto.js"></script>
\t\t
''')
