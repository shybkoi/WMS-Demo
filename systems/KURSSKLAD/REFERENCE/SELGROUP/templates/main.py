...
__CHEETAH_genTime__ = 1482336171.911
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:51 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REFERENCE\\SELGROUP\\templates\\main.tmpl'
...
class main(engine_main):
    ...
    def adminData(self, **KWS):
        ...
        ## CHEETAH: generated from #block adminData       at line 35, col 5.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write('''        <div id="dvTbl" style="float:left;position:relative;width:100%;"></div>
''')
...
''')
        ...
        write('''/selgroup.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="''')
