...
__CHEETAH_genTime__ = 1482336173.171
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:53 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\WH\\templates\\main.tmpl'
...
\t\t</div>
\t\t<div id="items">
\t\t\t<span title="\xd0\xe0\xe7\xec\xe5\xf0">\xd0</span> <input type=text id="size" value="10"/><br>
\t\t\t<hr>
\t\t\t<a href="#" title="\xd2\xe8\xef\xfb \xec\xe5\xf1\xf2\xee\xef\xee\xeb\xee\xe6\xe5\xed\xe8\xe9"><img src="''')
        _v = VFFSL(SL,"sp_img",True) # '$sp_img' on line 57, col 54
        if _v is not None: write(_filter(_v, rawExpr='$sp_img')) # from line 57, col 54.
        write('''/site.png"/></a>
\t\t\t<hr>
\t\t\t<a href="#" title="\xc7\xee\xed\xfb"><img src="''')
        _v = VFFSL(SL,"sp_img",True) # '$sp_img' on line 59, col 39
        if _v is not None: write(_filter(_v, rawExpr='$sp_img')) # from line 59, col 39.
        write('''/zone.png"/></a><br>
\t\t\t<hr>
\t\t\t<a href="#" title="\xd1\xee\xf5\xf0\xe0\xed\xe8\xf2\xfc"><img src="''')
        _v = VFFSL(SL,"sp_img",True) # '$sp_img' on line 61, col 44
        if _v is not None: write(_filter(_v, rawExpr='$sp_img')) # from line 61, col 44.
        write('''/save.png"/></a><br>
\t\t\t<hr>
\t\t\t<img title="\xca\xee\xf0\xe7\xe8\xed\xe0" id="trash" src="''')
        _v = VFFSL(SL,"sp_img",True) # '$sp_img' on line 63, col 41
        if _v is not None: write(_filter(_v, rawExpr='$sp_img')) # from line 63, col 41.
        write('''/trash.png"/>
            <hr>
            <a href="#" title="\xd2\xe8\xef\xfb \xec\xe5\xf1\xf2\xee\xef\xee\xeb\xee\xe6\xe5\xed\xe8\xe9"><img src="''')
        _v = VFFSL(SL,"sp_img",True) # '$sp_img' on line 65, col 63
        if _v is not None: write(_filter(_v, rawExpr='$sp_img')) # from line 65, col 63.
        write('''/site.png"/></a>
\t\t</div>
''')
...
''')
    ...
    <link href="''')
        _v = VFFSL(SL,"sps_css.MONITORINGWH",True) # '$sps_css.MONITORINGWH' on line 12, col 17
        if _v is not None: write(_filter(_v, rawExpr='$sps_css.MONITORINGWH')) # from line 12, col 17.
    ...
    <link href="''')
        ...
        write('''/wh.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="''')
