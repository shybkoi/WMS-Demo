...
__CHEETAH_genTime__ = 1482336172.392
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:52 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REPORTS\\RESERVE\\templates\\reservemain.tmpl'
...
class reservemain(engine_main):
    ...
    def rFilter(self, **KWS):
        ...
        ## CHEETAH: generated from #block rFilter at line 34, col 2.
        trans = KWS.get("trans")
...
''')
    ...
    def systemNavigation(self, **KWS):
        ...
        write('''\t<ul>
\t\t<li><a href="fundincome">\xcf\xf0\xe8\xf5\xee\xe4 \xf0\xe5\xe7\xe5\xf0\xe2\xe0</a></li>
\t\t<li><a href="summary">\xcf\xee \xf2\xee\xe2\xe0\xf0\xe0\xec</a></li>
\t</ul>
...
\t<link href="''')
        _v = VFFSL(SL,"sps_css.KURSSKLAD",True) # '$sps_css.KURSSKLAD' on line 12, col 14
        if _v is not None: write(_filter(_v, rawExpr='$sps_css.KURSSKLAD')) # from line 12, col 14.
...
''')
    ...
    def rData(self, **KWS):
        ...
        ## CHEETAH: generated from #block rData at line 42, col 2.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
...
''')
    ...
    _mainCheetahMethod_for_reservemain= 'writeBody'

## END CLASS DEFINITION

if not hasattr(reservemain, '_initCheetahAttributes'):
    templateAPIClass = getattr(reservemain, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(reservemain)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=reservemain()).run()
