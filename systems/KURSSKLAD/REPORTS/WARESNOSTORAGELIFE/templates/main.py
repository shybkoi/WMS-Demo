...
__CHEETAH_genTime__ = 1482336172.5550001
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:52 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REPORTS\\WARESNOSTORAGELIFE\\templates\\main.tmpl'
...
\t<script type="text/javascript" src="''')
        _v = VFFSL(SL,"eng_js",True) # '$eng_js' on line 7, col 38
        if _v is not None: write(_filter(_v, rawExpr='$eng_js')) # from line 7, col 38.
...
\t<script type="text/javascript" src="''')
        _v = VFFSL(SL,"sp_js",True) # '$sp_js' on line 17, col 38
        if _v is not None: write(_filter(_v, rawExpr='$sp_js')) # from line 17, col 38.
        write('''/WaresNoStorageLife.js"></script>
\t
\t<form id="frmFilter" class="buttons">
\t\t\xce\xe1\xfa\xe5\xea\xf2 \t<select id="selectZone"></select>
\t\t<button type="submit"><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 21, col 35
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 21, col 35.
        write('''/arrows/arrow_right.png"></button>&nbsp;&nbsp;&nbsp;
\t\t<button type="button" id="btnPrint"><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 22, col 49
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 22, col 49.
...
''')
    ...
    def engineData(self, **KWS):
        ...
        ## CHEETAH: generated from #def engineData at line 26, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
