...
__CHEETAH_genTime__ = 1482336172.4200001
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:52 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REPORTS\\RESTNOMOVE\\templates\\main.tmpl'
...
\t<script type="text/javascript" src="''')
        _v = VFFSL(SL,"eng_js",True) # '$eng_js' on line 27, col 38
        if _v is not None: write(_filter(_v, rawExpr='$eng_js')) # from line 27, col 38.
...
''')
        ...
        write('''\t<script type="text/javascript" src="''')
        _v = VFFSL(SL,"sp_js",True) # '$sp_js' on line 34, col 38
        if _v is not None: write(_filter(_v, rawExpr='$sp_js')) # from line 34, col 38.
        write('''/restnomove.js"></script>
\t
\t<form id="frmFindDate" class="buttons">
\t\t\xcf\xe5\xf0\xe8\xee\xe4 <input id="dbeg" type="text" size="8">&nbsp;<input id="dend" type="text" size="8">
\t\t\xd3\xf7\xe5\xf2    <select id="selType">
\t\t\t\t\t<option value="0">\xcd\xe5 \xe2\xfb\xe1\xf0\xe0\xed</option>
\t\t\t\t\t<option value="1" selected>\xcf\xe0\xf0\xf2\xe8\xee\xed\xed\xfb\xe9</option>
\t\t\t\t\t<option value="2">\xc4\xee\xea\xf3\xec\xe5\xed\xf2\xe0\xeb\xfc\xed\xfb\xe9</option>
\t\t\t\t</select>&nbsp;
\t\t\xc7\xee\xed\xe0 \t<select id="selectZone"></select>
\t\t<button type="submit"><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 44, col 35
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 44, col 35.
