...
__CHEETAH_genTime__ = 1482336172.2539999
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:52 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REPORTS\\PALLETPRINT\\templates\\palletcr.tmpl'
...
class palletcr(ppmain):
    ...
    def ppFilter(self, **KWS):
        ...
        write('''/palletcr.js"></script>
\t
    <form id="frmFilter" class="buttons">
\t\t<b>\xcf\xe5\xf0\xe8\xee\xe4 \xef\xee\xe8\xf1\xea\xe0 \xfd\xf2\xe8\xea\xe5\xf2\xee\xea \xef\xf0\xe8\xe5\xec\xea\xe8 \xe2\xee\xe7\xe2\xf0\xe0\xf2\xee\xe2:</b>
...
''')
    ...
    _mainCheetahMethod_for_palletcr= 'writeBody'

## END CLASS DEFINITION

if not hasattr(palletcr, '_initCheetahAttributes'):
    templateAPIClass = getattr(palletcr, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(palletcr)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=palletcr()).run()
