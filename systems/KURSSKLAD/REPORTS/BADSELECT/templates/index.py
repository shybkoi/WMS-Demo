...
__CHEETAH_genTime__ = 1482336172.1289999
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:52 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REPORTS\\BADSELECT\\templates\\index.tmpl'
...
\t<script type="text/javascript" src="''')
    ...
    <script type="text/javascript" src="''')
        ...
        write('''/badselect.js"></script>
    
\t<form class="buttons">
\t\t \xcf\xe5\xf0\xe8\xee\xe4: \xd1 <input id="bdate" type="text" size="8" />&nbsp;
\t\t \xcf\xee <input id="edate" type="text" size="8" />&nbsp;
\t\t \xce\xe1\xfa\xe5\xea\xf2 <select id="zone"> </select>
\t\t <button style="button" type="submit" id="go"><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 30, col 59
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 30, col 59.
