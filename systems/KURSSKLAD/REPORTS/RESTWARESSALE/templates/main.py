...
__CHEETAH_genTime__ = 1482336172.4400001
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:52 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REPORTS\\RESTWARESSALE\\templates\\main.tmpl'
...
class main(engine_main):
    ...
    def systemNavigation(self, **KWS):
        ...
        write('''    <form id="frmFilter" method="get" action="locate" class="buttons">
        <b>''')
        if False:
            _('Склад')
        _v = VFFSL(SL,"_",False)('Склад') # "$_('\xd1\xea\xeb\xe0\xe4')" on line 6, col 12
        if _v is not None: write(_filter(_v, rawExpr="$_('\xd1\xea\xeb\xe0\xe4')")) # from line 6, col 12.
        write(''':</b> <select id="whid" name=whid style="width:100px;"></select> &nbsp;&nbsp;&nbsp;
\t\t''')
        if False:
            _('Продажи за период')
        _v = VFFSL(SL,"_",False)('Продажи за период') # "$_('\xcf\xf0\xee\xe4\xe0\xe6\xe8 \xe7\xe0 \xef\xe5\xf0\xe8\xee\xe4')" on line 7, col 3
        if _v is not None: write(_filter(_v, rawExpr="$_('\xcf\xf0\xee\xe4\xe0\xe6\xe8 \xe7\xe0 \xef\xe5\xf0\xe8\xee\xe4')")) # from line 7, col 3.
        write(''': <input id="bdate" type="text" size="8" />&nbsp;<input id="edate" type="text" size="8" />&nbsp;
\t\t<button style="button" type="submit" id="go"><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 8, col 58
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 8, col 58.
        write('''/arrows/arrow_right.png"></button>
\t\t&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button id="btnPrint" type="button" title="\xcf\xe5\xf7\xe0\xf2\xfc \xf1\xef\xe8\xf1\xea\xe0"><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 10, col 77
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 10, col 77.
...
''')
    ...
    def engineData(self, **KWS):
        ...
        ## CHEETAH: generated from #def engineData at line 14, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
...
''')
    ...
    <script type="text/javascript" src="''')
        _v = VFFSL(SL,"sp_js",True) # '$sp_js' on line 36, col 41
        if _v is not None: write(_filter(_v, rawExpr='$sp_js')) # from line 36, col 41.
        write('''/restWaresSale.js"></script>

    <div id="dvWH" style="float:left;position:relative;width:100%;"></div>
''')
