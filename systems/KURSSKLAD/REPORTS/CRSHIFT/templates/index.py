...
__CHEETAH_genTime__ = 1482336172.1489999
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:52 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REPORTS\\CRSHIFT\\templates\\index.tmpl'
...
class index(engine_main):
    ...
    def systemNavigation(self, **KWS):
        ...
        _v = VFFSL(SL,"sps_css.KURSSKLAD",True) # '$sps_css.KURSSKLAD' on line 8, col 62
        if _v is not None: write(_filter(_v, rawExpr='$sps_css.KURSSKLAD')) # from line 8, col 62.
...
\t<script type="text/javascript" src="''')
        _v = VFFSL(SL,"eng_js",True) # '$eng_js' on line 22, col 38
        if _v is not None: write(_filter(_v, rawExpr='$eng_js')) # from line 22, col 38.
...
\t
    <script type="text/javascript" src="''')
        ...
        write('''/crshift.js"></script>

\t<form class="buttons">
\t\t\xce\xe1\xfa\xe5\xea\xf2 ''')
        # <select id="zone" multiple size="1"> </select>
        write('''
\t\t\t<button type="button" id="zone" obj=""><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 32, col 53
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 32, col 53.
        write('''/actions/application_view_detail.png"></button>
\t\t\xc4\xe0\xf2\xe0: <input id="dbeg" type="text" size="8" /> <input type="text" id="tbeg" size="5" value="00:00">&nbsp;<input type="text" id="tend" size="5" value="23:59">
''')
        # <input id="dend" type="text" size="8" /> 
        write('''\t\t<button style="button" type="submit" id="go"><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 35, col 58
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 35, col 58.
