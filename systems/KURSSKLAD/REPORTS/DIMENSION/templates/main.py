...
__CHEETAH_genTime__ = 1482336172.2119999
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:52 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REPORTS\\DIMENSION\\templates\\main.tmpl'
...
''')
    ...
    <script type="text/javascript" src="''')
        ...
        write('''/k.simpleWaresMovings.js"></script>
    <script type="text/javascript" src="''')
    ...
    <script type="text/javascript" src="''')
        ...
        write('''/dimension.js"></script>

\t<form class="buttons">
\t\t\xce\xe1\xfa\xe5\xea\xf2: <select id="sitezoneid"></select>
\t\t<button type="submit" title="\xcf\xee\xe8\xf1\xea"><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 32, col 49
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 32, col 49.
        write('''/actions/find.png"></button>
\t</form>
\t
''')
    ...
    def engineData(self, **KWS):
        ...
        ## CHEETAH: generated from #def engineData at line 37, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write('''    <div id="dvMain" style="width:100%;">
\t\t<div id="dvWares" style="float:left;position:relative;width:50%;height:100%;"></div>
\t\t<div id="dvWaresUnit" style="float:left;position:relative;width:50%;height:100%;"></div>
\t</div> 
''')
