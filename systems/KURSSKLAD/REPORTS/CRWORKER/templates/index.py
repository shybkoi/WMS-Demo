...
__CHEETAH_genTime__ = 1482336172.1730001
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:52 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REPORTS\\CRWORKER\\templates\\index.tmpl'
...
class index(engine_main):
    ...
    def systemNavigation(self, **KWS):
        ...
        _v = VFFSL(SL,"sps_css.KURSSKLAD",True) # '$sps_css.KURSSKLAD' on line 10, col 62
        if _v is not None: write(_filter(_v, rawExpr='$sps_css.KURSSKLAD')) # from line 10, col 62.
...
\t<script type="text/javascript" src="''')
        _v = VFFSL(SL,"eng_js",True) # '$eng_js' on line 25, col 38
        if _v is not None: write(_filter(_v, rawExpr='$eng_js')) # from line 25, col 38.
...
\t<script type="text/javascript" src="''')
        _v = VFFSL(SL,"sps_js.KURSSKLAD",True) # '$sps_js.KURSSKLAD' on line 30, col 38
        if _v is not None: write(_filter(_v, rawExpr='$sps_js.KURSSKLAD')) # from line 30, col 38.
        write('''/k.helpers.js"></script>
\t
    <script type="text/javascript" src="''')
        _v = VFFSL(SL,"sp_js",True) # '$sp_js' on line 32, col 41
        if _v is not None: write(_filter(_v, rawExpr='$sp_js')) # from line 32, col 41.
        write('''/crworker.js"></script>
\t
\t<form class="buttons">
\t\t \xcf\xe5\xf0\xe8\xee\xe4: \xd1 <input id="dbeg" type="text" size="8" />&nbsp;<input type="text" id="tbeg" size="5">
\t\t \xcf\xee <input id="dend" type="text" size="8" />&nbsp;<input type="text" id="tend" size="5">
''')
        # Объект ##<select id="zone"> </select>
        write('''\t\t <button style=\'display:none;\' type="button" id="zone" obj=""><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 38, col 75
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 38, col 75.
        write('''/actions/application_view_detail.png"></button>
\t\t \xd2\xe8\xef \xf0\xe0\xe1\xee\xf2\xfb <select id="wtype"> 
\t\t\t\t\t\t<option selected value="t">\xd2\xe5\xf0\xec\xe8\xed\xe0\xeb</option>
\t\t\t\t\t\t<option value="p">\xcf\xca</option>
\t\t\t\t\t\t<option value="a">\xc2\xf1\xe5</option>
\t\t            </select>
\t\t <button style="button" type="submit" id="go"><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 44, col 59
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 44, col 59.
        write('''/arrows/arrow_right.png"></button>
         <button id="btnPrint" type="button" title="\xcf\xe5\xf7\xe0\xf2\xfc"><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 45, col 71
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 45, col 71.
...
''')
    ...
    def engineData(self, **KWS):
        ...
        write('''\t<div id="dvMain" style="width:100%;float:left;position:relative;">
