...
__CHEETAH_genTime__ = 1482336172.7
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:52 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REPORTS\\WORKTASKRATE\\templates\\wtrmain.tmpl'
...
class wtrmain(engine_main):
    ...
    def systemNavigation(self, **KWS):
        ...
        # 		<li><a href="workTaskRate">По типам</a></li>
        # 		<li><a href="workTaskRateByEmpl">По сотруднику</a></li>
        # 	</ul>
        write('''
...
''')
    ...
    def wtrData(self, **KWS):
        ...
        ## CHEETAH: generated from #block wtrData at line 39, col 2.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
...
''')
    ...
    _mainCheetahMethod_for_wtrmain= 'writeBody'

## END CLASS DEFINITION

if not hasattr(wtrmain, '_initCheetahAttributes'):
    templateAPIClass = getattr(wtrmain, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(wtrmain)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=wtrmain()).run()
