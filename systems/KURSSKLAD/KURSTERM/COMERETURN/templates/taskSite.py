...
__CHEETAH_genTime__ = 1482336168.3499999
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:48 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\KURSTERM\\COMERETURN\\templates\\taskSite.tmpl'
...
''')
    ...
    _mainCheetahMethod_for_taskSite= 'writeBody'

## END CLASS DEFINITION

if not hasattr(taskSite, '_initCheetahAttributes'):
    templateAPIClass = getattr(taskSite, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(taskSite)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=taskSite()).run()
