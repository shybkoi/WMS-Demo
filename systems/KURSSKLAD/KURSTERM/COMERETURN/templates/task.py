...
''')
        ...
        <thead>
            ...
            if False:
                _('Код')
            _v = VFFSL(SL,"_",False)('Код') # "$_('\xca\xee\xe4')" on line 29, col 21
            if _v is not None: write(_filter(_v, rawExpr="$_('\xca\xee\xe4')")) # from line 29, col 21.
            write('''</th>
                <th>''')
            if False:
                _('План')
            _v = VFFSL(SL,"_",False)('План') # "$_('\xcf\xeb\xe0\xed')" on line 30, col 21
            if _v is not None: write(_filter(_v, rawExpr="$_('\xcf\xeb\xe0\xed')")) # from line 30, col 21.
            write('''</th>
                <th>''')
            if False:
                _('Факт')
            _v = VFFSL(SL,"_",False)('Факт') # "$_('\xd4\xe0\xea\xf2')" on line 31, col 21
...
''')
        if VFFSL(SL,"ALGORITHM",True) and VFFSL(SL,"ALGORITHM",True)=='W': # generated from line 68, col 4
            ...
            if False:
                _('Коносамент')
            _v = VFFSL(SL,"_",False)('Коносамент') # "$_('\xca\xee\xed\xee\xf1\xe0\xec\xe5\xed\xf2')" on line 69, col 35
...
''')
            ...
            if False:
                _('Вы  уверены?')
            _v = VFFSL(SL,"_",False)('Вы  уверены?') # "$_('\xc2\xfb  \xf3\xe2\xe5\xf0\xe5\xed\xfb?')" on line 71, col 43
            ...
            if False:
                _('Завершить')
            _v = VFFSL(SL,"_",False)('Завершить') # "$_('\xc7\xe0\xe2\xe5\xf0\xf8\xe8\xf2\xfc')" on line 71, col 99
