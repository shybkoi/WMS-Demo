...
__CHEETAH_genTime__ = 1482336169.7980001
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:49 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\KURSTERM\\MODELSTACK\\templates\\index.tmpl'
...
class index(main):
    ...
    def mainData(self, **KWS):
        ...
        if False:
            _('Местоположение')
        _v = VFFSL(SL,"_",False)('Местоположение') # "$_('\xcc\xe5\xf1\xf2\xee\xef\xee\xeb\xee\xe6\xe5\xed\xe8\xe5')" on line 6, col 71
        if _v is not None: write(_filter(_v, rawExpr="$_('\xcc\xe5\xf1\xf2\xee\xef\xee\xeb\xee\xe6\xe5\xed\xe8\xe5')")) # from line 6, col 71.
        write('''">
    </form>
''')
