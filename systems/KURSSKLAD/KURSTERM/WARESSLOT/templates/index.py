...
__CHEETAH_genTime__ = 1482336171.3150001
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:51 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\KURSTERM\\WARESSLOT\\templates\\index.tmpl'
...
class index(main):
    ...
    def mainData(self, **KWS):
        ...
        if False:
            _('МО')
        _v = VFFSL(SL,"_",False)('МО') # "$_('\xcc\xce')" on line 6, col 84
        if _v is not None: write(_filter(_v, rawExpr="$_('\xcc\xce')")) # from line 6, col 84.
        write('''">
    </form>
''')
