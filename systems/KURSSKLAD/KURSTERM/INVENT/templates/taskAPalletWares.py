...
__CHEETAH_genTime__ = 1482336169.3540001
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:49 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\KURSTERM\\INVENT\\templates\\taskAPalletWares.tmpl'
...
''')
        if VFFSL(SL,"SPCODE",True)!='TRASH': # generated from line 25, col 5
            if VFFSL(SL,"varExists",False)('$datalist') and VFFSL(SL,"datalist",True) and len(VFFSL(SL,"datalist",True))>0: # generated from line 26, col 10
                wuamount = 0
                amount = 0
                write('''        <form action=taskAPalletWaresSave method=post>
            <input type=hidden name=wid value=''')
...
''')
			...
			self._CHEETAH__filters[filterName] = getattr(self._CHEETAH__filtersLib, filterName)(self).filter
                        ...
                        _filter = _orig_filter_62381900
                        write('''" size="4"></td>
''')
                    else: # generated from line 59, col 23
                        write('''                        <td><a href=\'#\' title="">''')
                        _orig_filter_70943332 = _filter
                        filterName = 'Quantity'
                        if self._CHEETAH__filters.has_key("Quantity"):
                            _filter = self._CHEETAH__currentFilter = self._CHEETAH__filters[filterName]
                        else:
...
''')
        ...
        <a href="taskAPalletWaresAdd?pid=''')
...
''')
    ...
    _mainCheetahMethod_for_taskAPalletWares= 'writeBody'

## END CLASS DEFINITION

if not hasattr(taskAPalletWares, '_initCheetahAttributes'):
    templateAPIClass = getattr(taskAPalletWares, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(taskAPalletWares)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=taskAPalletWares()).run()
