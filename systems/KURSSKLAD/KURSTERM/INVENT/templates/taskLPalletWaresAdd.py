...
__CHEETAH_genTime__ = 1482336169.5569999
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:49 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\KURSTERM\\INVENT\\templates\\taskLPalletWaresAdd.tmpl'
...
class taskLPalletWaresAdd(main):
...
''')
        ...
        write('''<br>
    <hr>
    <form action="taskLPalletWaresAdd" name="frm"  method=post>
...
''')
    ...
    _mainCheetahMethod_for_taskLPalletWaresAdd= 'writeBody'

## END CLASS DEFINITION

if not hasattr(taskLPalletWaresAdd, '_initCheetahAttributes'):
    templateAPIClass = getattr(taskLPalletWaresAdd, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(taskLPalletWaresAdd)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=taskLPalletWaresAdd()).run()
