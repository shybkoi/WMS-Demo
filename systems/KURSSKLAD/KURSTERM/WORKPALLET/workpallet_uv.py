...
from systems.KURSSKLAD.KURSTERM.WORKPALLET.templates.UV.palletFPCreate import palletFPCreate as palletFPCreateUV

class TWorkPalletUV(TWorkPallet):
        ...
        if barcode:
            ...
            if truth(match('02\d{14}15\d{6}37\d{6}', barcode)):
                try:
                    ...
                    return self.drawTemplate(templ=palletFPCreate, data=[bc, pf, params])
