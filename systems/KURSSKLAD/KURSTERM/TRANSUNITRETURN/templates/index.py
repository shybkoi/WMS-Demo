...
__CHEETAH_genTime__ = 1482336171.3099999
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:51 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\KURSTERM\\TRANSUNITRETURN\\templates\\index.tmpl'
...
class index(main):
    ...
    def mainData(self, **KWS):
        ...
        if False:
            _('Авто')
        _v = VFFSL(SL,"_",False)('Авто') # "$_('\xc0\xe2\xf2\xee')" on line 6, col 71
        if _v is not None: write(_filter(_v, rawExpr="$_('\xc0\xe2\xf2\xee')")) # from line 6, col 71.
        write('''">
    </form>
''')
