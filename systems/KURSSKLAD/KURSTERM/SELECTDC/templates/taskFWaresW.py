...
__CHEETAH_genTime__ = 1482336170.4590001
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:50 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\KURSTERM\\SELECTDC\\templates\\taskFWaresW.tmpl'
...
''')
        write('''    <hr>
''')
        if VFFSL(SL,"varExists",False)('$QS') and VFFSL(SL,"QS",True): # generated from line 41, col 5
            write('''        \xce\xf2\xee\xe1\xf0\xe0\xed\xee: <a href="taskFWaresWClear?twid=''')
            _v = VFFSL(SL,"TWID",True) # '$TWID' on line 42, col 50
            if _v is not None: write(_filter(_v, rawExpr='$TWID')) # from line 42, col 50.
            write('''" title="''')
            if False:
                _('Очистить')
            _v = VFFSL(SL,"_",False)('Очистить') # "$_('\xce\xf7\xe8\xf1\xf2\xe8\xf2\xfc')" on line 42, col 64
            if _v is not None: write(_filter(_v, rawExpr="$_('\xce\xf7\xe8\xf1\xf2\xe8\xf2\xfc')")) # from line 42, col 64.
            ...
            if self._CHEETAH__filters.has_key("Quantity"):
                ...
                _filter = self._CHEETAH__currentFilter = \
			self._CHEETAH__filters[filterName] = getattr(self._CHEETAH__filtersLib, filterName)(self).filter
            _v = VFFSL(SL,"QS",True) # '$QS' on line 42, col 163
            if _v is not None: write(_filter(_v, rawExpr='$QS')) # from line 42, col 163.
            _filter = _orig_filter_56058997
            _v = VFFSL(SL,"MUCODE",True) # '$MUCODE' on line 42, col 178
            if _v is not None: write(_filter(_v, rawExpr='$MUCODE')) # from line 42, col 178.
            write('''</a>
''')
        else: # generated from line 43, col 5
            write('''        <a href="taskFWaresWeight?twid=''')
            _v = VFFSL(SL,"TWID",True) # '$TWID' on line 44, col 40
            if _v is not None: write(_filter(_v, rawExpr='$TWID')) # from line 44, col 40.
...
''')
    ...
    <form action="taskFWares">
        ...
        _v = VFFSL(SL,"TWID",True) # '$TWID' on line 48, col 49
        if _v is not None: write(_filter(_v, rawExpr='$TWID')) # from line 48, col 49.
        write('''">
...
\t</form>
    ...
    <a href="taskFWaresEnd?twid=''')
        _v = VFFSL(SL,"TWID",True) # '$TWID' on line 52, col 33
        if _v is not None: write(_filter(_v, rawExpr='$TWID')) # from line 52, col 33.
        write('''&pc=12">\xcd\xe5\xf2 \xf2\xee\xe2\xe0\xf0\xe0 \xed\xe0 \xef\xee\xe4\xe4\xee\xed\xe5</a><br>
''')
        if not VFFSL(SL,"varExists",False)('$QS') or not VFFSL(SL,"QS",True): # generated from line 53, col 5
            write("""        <a href='qTaskFWaresNoPlace?twid=""")
            _v = VFFSL(SL,"TWID",True) # '$TWID' on line 54, col 42
            if _v is not None: write(_filter(_v, rawExpr='$TWID')) # from line 54, col 42.
            write('''\' onClick="return confirm(\'''')
            if False:
                _('Нет места на поддоне')
            _v = VFFSL(SL,"_",False)('Нет места на поддоне') # "$_('\xcd\xe5\xf2 \xec\xe5\xf1\xf2\xe0 \xed\xe0 \xef\xee\xe4\xe4\xee\xed\xe5')" on line 54, col 74
            if _v is not None: write(_filter(_v, rawExpr="$_('\xcd\xe5\xf2 \xec\xe5\xf1\xf2\xe0 \xed\xe0 \xef\xee\xe4\xe4\xee\xed\xe5')")) # from line 54, col 74.
            write('''\\n---------------------------------\\n''')
            if False:
                _('Вы уверены?')
            _v = VFFSL(SL,"_",False)('Вы уверены?') # "$_('\xc2\xfb \xf3\xe2\xe5\xf0\xe5\xed\xfb?')" on line 54, col 137
            if _v is not None: write(_filter(_v, rawExpr="$_('\xc2\xfb \xf3\xe2\xe5\xf0\xe5\xed\xfb?')")) # from line 54, col 137.
            write('''\')">''')
            if False:
                _('Нет места на поддоне')
            _v = VFFSL(SL,"_",False)('Нет места на поддоне') # "$_('\xcd\xe5\xf2 \xec\xe5\xf1\xf2\xe0 \xed\xe0 \xef\xee\xe4\xe4\xee\xed\xe5')" on line 54, col 158
            if _v is not None: write(_filter(_v, rawExpr="$_('\xcd\xe5\xf2 \xec\xe5\xf1\xf2\xe0 \xed\xe0 \xef\xee\xe4\xe4\xee\xed\xe5')")) # from line 54, col 158.
            write('''</a>
''')
    ...
    _mainCheetahMethod_for_taskFWaresW= 'writeBody'

## END CLASS DEFINITION

if not hasattr(taskFWaresW, '_initCheetahAttributes'):
    templateAPIClass = getattr(taskFWaresW, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(taskFWaresW)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=taskFWaresW()).run()
