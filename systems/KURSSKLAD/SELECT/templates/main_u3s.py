...
__CHEETAH_genTime__ = 1482336173.027
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:53 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\SELECT\\templates\\main_u3s.tmpl'
...
class main_u3s(engine_main):
    ...
    def adminData(self, **KWS):
        ...
        ## CHEETAH: generated from #block adminData    at line 47, col 5.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
...
''')
    ...
    <script type="text/javascript" src="''')
        _v = VFFSL(SL,"sp_js",True) # '$sp_js' on line 42, col 41
        if _v is not None: write(_filter(_v, rawExpr='$sp_js')) # from line 42, col 41.
        write('''/Select_U3S.js"></script>
    <script type="text/javascript">
        var saleThroughName = \'''')
        _v = VFFSL(SL,"moduleConf.saleThroughName",True) # '$moduleConf.saleThroughName' on line 44, col 32
        if _v is not None: write(_filter(_v, rawExpr='$moduleConf.saleThroughName')) # from line 44, col 32.
        write("""';
    </script>
...
''')
    ...
    _mainCheetahMethod_for_main_u3s= 'writeBody'

## END CLASS DEFINITION

if not hasattr(main_u3s, '_initCheetahAttributes'):
    templateAPIClass = getattr(main_u3s, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(main_u3s)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=main_u3s()).run()
