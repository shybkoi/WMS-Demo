...
__CHEETAH_genTime__ = 1482336173.0510001
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:53 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\SELECT\\templates\\main_uv.tmpl'
...
''')
    ...
    _mainCheetahMethod_for_main_uv= 'writeBody'

## END CLASS DEFINITION

if not hasattr(main_uv, '_initCheetahAttributes'):
    templateAPIClass = getattr(main_uv, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(main_uv)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=main_uv()).run()
