...
__CHEETAH_genTime__ = 1482336172.0550001
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:52 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REFILLSLOT\\templates\\main.tmpl'
...
class main(rfsmain):
    ...
    def adminData(self, **KWS):
        ...
        ## CHEETAH: generated from #block adminData    at line 36, col 5.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write('''        <div id="dvWH" style="float:left;position:relative;overflow:auto;"></div>
''')
...
''')
        # Styles
        write('''    <link href="''')
        _v = VFFSL(SL,"eng_css",True) # '$eng_css' on line 10, col 17
        if _v is not None: write(_filter(_v, rawExpr='$eng_css')) # from line 10, col 17.
