...
__CHEETAH_genTime__ = 1482336172.0899999
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:52 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REFILLSLOT\\templates\\wares.tmpl'
...
class wares(rfsmain):
    ...
    def rfsFilter(self, **KWS):
        ...
        write('''    <form id=frmFilter action=listWares class="buttons">
...
''')
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button style="button" type=submit><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 23, col 54
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 23, col 54.
        write('''/arrows/arrow_right.png"/></button>
        <button style="button" type=button id=btnPrint><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 24, col 66
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 24, col 66.
        write('''/actions/printer.png"/></button>
        <button style="button" type=button id=btnFilter><img src="''')
        _v = VFFSL(SL,"eng_img",True) # '$eng_img' on line 25, col 67
        if _v is not None: write(_filter(_v, rawExpr='$eng_img')) # from line 25, col 67.
        write('''/actions/open.png"/></button>
    </form>
''')
    ...
    def rfsData(self, **KWS):
        ...
        ## CHEETAH: generated from #def rfsData    at line 29, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        # Styles
        write('''    <link href="''')
        _v = VFFSL(SL,"eng_css",True) # '$eng_css' on line 31, col 17
        if _v is not None: write(_filter(_v, rawExpr='$eng_css')) # from line 31, col 17.
        write('''/contextMenu.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="''')
        _v = VFFSL(SL,"sps_css.KURSSKLAD",True) # '$sps_css.KURSSKLAD' on line 32, col 17
        if _v is not None: write(_filter(_v, rawExpr='$sps_css.KURSSKLAD')) # from line 32, col 17.
...
''')
    ...
    <script type="text/javascript" src="''')
        _v = VFFSL(SL,"sps_js.KURSSKLAD",True) # '$sps_js.KURSSKLAD' on line 51, col 41
        if _v is not None: write(_filter(_v, rawExpr='$sps_js.KURSSKLAD')) # from line 51, col 41.
        write('''/k.progressbar.js"></script>
    <script type="text/javascript" src="''')
        _v = VFFSL(SL,"sps_js.KURSSKLAD",True) # '$sps_js.KURSSKLAD' on line 52, col 41
        if _v is not None: write(_filter(_v, rawExpr='$sps_js.KURSSKLAD')) # from line 52, col 41.
