...
__CHEETAH_genTime__ = 1482336172.1099999
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:52 2016'
__CHEETAH_src__ = 'systems\\KURSSKLAD\\REFILLSLOTOLD\\templates\\main.tmpl'
...
class main(engine_main):
    ...
    def adminData(self, **KWS):
        ...
        ## CHEETAH: generated from #block adminData    at line 39, col 5.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
...
''')
        ...
        write('''    <script type="text/javascript" src="''')
        _v = VFFSL(SL,"sp_js",True) # '$sp_js' on line 37, col 41
        if _v is not None: write(_filter(_v, rawExpr='$sp_js')) # from line 37, col 41.
