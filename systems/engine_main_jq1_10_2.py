...
__CHEETAH_genTime__ = 1482336164.0039999
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:44 2016'
__CHEETAH_src__ = 'systems\\engine_main_jq1_10_2.tmpl'
...
class engine_main_jq1_10_2(Template):
...
''')
    ...
    <script type="text/javascript" src="''')
        ...
        write('''/jquery/1.10.2/jquery-1.10.2.min.js"></script>
    <script type="text/javascript" src="''')
...
''')
    ...
    _mainCheetahMethod_for_engine_main_jq1_10_2= 'respond'

## END CLASS DEFINITION

if not hasattr(engine_main_jq1_10_2, '_initCheetahAttributes'):
    templateAPIClass = getattr(engine_main_jq1_10_2, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(engine_main_jq1_10_2)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=engine_main_jq1_10_2()).run()
