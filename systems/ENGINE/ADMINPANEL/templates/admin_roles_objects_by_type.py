...
__CHEETAH_genTime__ = 1482336166.086
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:46 2016'
__CHEETAH_src__ = 'systems\\ENGINE\\ADMINPANEL\\templates\\admin_roles_objects_by_type.tmpl'
...
class admin_roles_objects_by_type(Template):
...
''')
    ...
    _mainCheetahMethod_for_admin_roles_objects_by_type= 'respond'

## END CLASS DEFINITION

if not hasattr(admin_roles_objects_by_type, '_initCheetahAttributes'):
    templateAPIClass = getattr(admin_roles_objects_by_type, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(admin_roles_objects_by_type)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=admin_roles_objects_by_type()).run()
