...
__CHEETAH_genTime__ = 1482336166.2609999
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:46 2016'
__CHEETAH_src__ = 'systems\\ENGINE\\ADMINPANEL\\templates\\admin_systems_objects_by_type.tmpl'
...
class admin_systems_objects_by_type(Template):
...
''')
        N = 1
        for item in VFFSL(SL,"objects",True): # generated from line 13, col 9
            write('''            <tr id="''')
...
''')
    ...
    _mainCheetahMethod_for_admin_systems_objects_by_type= 'respond'

## END CLASS DEFINITION

if not hasattr(admin_systems_objects_by_type, '_initCheetahAttributes'):
    templateAPIClass = getattr(admin_systems_objects_by_type, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(admin_systems_objects_by_type)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=admin_systems_objects_by_type()).run()
