...
__CHEETAH_genTime__ = 1482336165.237
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:45 2016'
__CHEETAH_src__ = 'systems\\engine_main_jq2_0_3.tmpl'
...
class engine_main_jq2_0_3(Template):
...
''')
    ...
    _mainCheetahMethod_for_engine_main_jq2_0_3= 'respond'

## END CLASS DEFINITION

if not hasattr(engine_main_jq2_0_3, '_initCheetahAttributes'):
    templateAPIClass = getattr(engine_main_jq2_0_3, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(engine_main_jq2_0_3)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=engine_main_jq2_0_3()).run()
