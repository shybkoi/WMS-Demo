...
__CHEETAH_genTime__ = 1482336165.4319999
__CHEETAH_genTimestamp__ = 'Wed Dec 21 18:02:45 2016'
__CHEETAH_src__ = 'systems\\engine_main_jq2_1_1.tmpl'
...
class engine_main_jq2_1_1(Template):
...
''')
    ...
    <script type="text/javascript" src="''')
        ...
        write('''/jquery/2.1.1/jquery-2.1.1.min.js"></script>
    <script type="text/javascript" src="''')
...
''')
    ...
    _mainCheetahMethod_for_engine_main_jq2_1_1= 'respond'

## END CLASS DEFINITION

if not hasattr(engine_main_jq2_1_1, '_initCheetahAttributes'):
    templateAPIClass = getattr(engine_main_jq2_1_1, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(engine_main_jq2_1_1)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=engine_main_jq2_1_1()).run()
