...
$.widget("ui.droppable", {
	...
	_drop: function(e,custom) {
		...
		this.element.find(":data(droppable)").not(".ui-draggable-dragging").each(function() {
			...
			if(inst.options.greedy && $.ui.intersect(draggable, $.extend(inst, { offset: inst.element.offset() }), inst.options.tolerance, e)) {
        ...
        if(this.options.accept.call(this.element,(draggable.currentItem || draggable.element))) {
            if (this.options.drop && $.isFunction(this.options.drop) ) this.options.drop.call(this, e, this.ui(draggable));
...
$.ui.intersect = function(draggable, droppable, toleranceMode, e) {
	...
	switch (toleranceMode) {
		...
		case 'touch':
			...
			break;
        case 'mouse':
			return ( l < e.pageX && e.pageX < r && t < e.pageY && e.pageY < b);
			break;            
		default:
			return false;
			break;
...
$.ui.ddmanager = {
	...
	drop: function(draggable, e) {
		...
		$.each($.ui.ddmanager.droppables[draggable.options.scope], function() {
            ...
            if (!this.options.disabled && this.visible && $.ui.intersect(draggable, this, this.options.tolerance, e))
	...
	drag: function(draggable, e) {
		...
		$.each($.ui.ddmanager.droppables[draggable.options.scope], function() {
			...
			var intersects = $.ui.intersect(draggable, this, this.options.tolerance, e);
