...
return false;return true;},_mouseStart:function(e){var o=this.options;this.helper=this.createHelper(e);if($.ui.ddmanager)
...
return position;},_mouseDrag:function(e){this.position=this._generatePosition(e);this.positionAbs=this._convertPositionTo("absolute");this.position=this._propagate("drag",e)||this.position;if(!this.options.axis||this.options.axis!="y")
this.helper[0].style.left=(this.options.helperPos=='mouse')?((e.clientX+3)+'px'):(this.position.left+'px');if(!this.options.axis||this.options.axis!="x")
this.helper[0].style.top=(this.options.helperPos=='mouse')?((e.clientY+3)+'px'):(this.position.top+'px');if($.ui.ddmanager)$.ui.ddmanager.drag(this,e);return false;},_mouseStop:function(e){var dropped=false;if($.ui.ddmanager&&!this.options.dropBehaviour)
