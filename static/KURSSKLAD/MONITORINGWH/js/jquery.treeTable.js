...
(function($) {
    ...
    return this.each(function() {
      $(this).addClass("treeTable").find("tbody tr").each(function() {
        ...
        if (!$(this).hasClass('initialized')) {
          ...
          if(!isRootNode && options.expandable && options.initialState == "collapsedTT") {
  ...
  $.fn.collapse = function() {
    return this.each(function() {
      $(this).removeClass("expanded").addClass("collapsedTT");
  ...
  $.fn.expand = function() {
    return this.each(function() {
      $(this).removeClass("collapsedTT").addClass("expanded");
    ...
    if(!node.hasClass("initialized")) {
      ...
      if(node.hasClass("parent")) {
        ...
        if(options.expandable) {
          ...
          if(!(node.hasClass("expanded") || node.hasClass("collapsedTT"))) {
